...
{
    public sealed partial class FDImgBox : UserControl
    {
        ...
        public void UNLOAD()
        {
            this.GifImage_Unloaded(this, new RoutedEventArgs());
        }
        public void LOAD()
        {
            this.GifImage_Loaded(this, new RoutedEventArgs());
        }

        private async static void OnSourcePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var that = d as FDImgBox;
